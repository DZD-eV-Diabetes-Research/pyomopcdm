...
changed from cdm6 to cdm54
https://ohdsi.github.io/CommonDataModel/cdm54.html

ORM - creating OMOP CDM v5.4 like objects with the help of sqlalchemy
"""
...
class CdmSource(Base):
    ...
    cdm_version_concept_id = Column(Integer, nullable=True)
    vocabulary_version = Column(String(20), nullable=True)
...
class DeviceExposure(Base):
    ...
    unit_source_concept_id = Column(Integer)
...
class Episode(Base):
    ...
    episode_start_date = Column(String(30), nullable=False)
    episode_start_datetime = Column(String(10))
    episode_end_date = Column(String(30))
    episode_end_datetime = Column(String(10))
...
class Location(Base):
    ...
    country_concept_id = Column(Integer)
...
class Measurement(Base):
    ...
    meas_event_field_concept_id = Column(Integer)
...
class ProcedureOccurrence(Base):
    ...
    procedure_end_date = Column(String(30))
    procedure_end_datetime = Column(String(10))
...
class VisitDetail(Base):
    ...
    parent_visit_detail_id = Column(Integer)
...
class VisitOccurrence(Base):
    ...
    admitting_from_concept_id = Column(Integer)
    admitting_from_source_value = Column(String(50))
    discharge_to_concept_id = Column(Integer)
    discharge_to_source_value = Column(String(50))
